package com.suryakalyan.ecosort;// FeedViewHolder.java
...
public class FeedViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bindData( LocationData model) {
        ...
        textViewComplainer.setText("Complainer: " + model.getTitle());
        textViewDateTime.setText(model.getSnippet());
        textViewLatitude.setText("Latitude: " + model.getPosition().latitude);
        textViewLongitude.setText("Longitude: " + model.getPosition().longitude);
        textViewAddress.setText("Address: " + model.getAddress());
